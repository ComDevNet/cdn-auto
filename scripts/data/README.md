...
- OC4D mapping files:
  - `config/oc4d/student-map.csv` with `source_student_name,studentId,parentOrg` for optional student overrides; new students can resolve automatically from cloud roster/S3 prefix data
