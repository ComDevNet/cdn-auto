...
mkdir -p "$DATA_DIR" "$PROCESSED_ROOT"
...
queued_csv="$QUEUE_DIR/RACHEL/pending/site_daily_access_logs.csv"
...
queued_csv="$QUEUE_DIR/RACHEL/pending/site_weekly_access_logs.csv"
...
assert_eq "$(read_queue_run_sidecar "$QUEUE_DIR/RACHEL/pending/site_daily_access_logs.csv")" "site_logs_2025_06_27" "queue_one sidecar"
...
assert_eq "$(read_queue_run_sidecar "$QUEUE_DIR/ModuleGaze/pending/site_daily_modulegaze_logs.csv")" "site_modulegaze_logs_2025_06_28" "modulegaze queue_one sidecar"
