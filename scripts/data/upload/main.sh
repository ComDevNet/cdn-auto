...
echo ""
echo "=============================================================="
echo "Upload processed logs to AWS S3"
echo "=============================================================="
echo ""
...
echo -e "2. Upload ModuleGaze Logs ${DARK_GRAY}-| Upload processed ModuleGaze CSV files${NC}"
echo -e "3. Upload OC4D Assessments${DARK_GRAY}-| Pull OC4D assessment results and upload${NC}"
echo -e "4. Configure AWS CLI      ${DARK_GRAY}-| Configure AWS CLI${NC}"
echo -e "5. Change s3 Bucket       ${DARK_GRAY}-| Change s3 Bucket URI${NC}"
echo -e "${GREEN}6. Go Back                ${DARK_GRAY}-| Go back to the data menu${NC}"
