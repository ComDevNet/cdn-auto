...
OC4D_API_IDENTIFIER="${OC4D_API_IDENTIFIER:-admin@comdevnet.com}"
OC4D_API_PASSWORD="${OC4D_API_PASSWORD:-}"
OC4D_API_CREDENTIALS_FILE="${OC4D_API_CREDENTIALS_FILE:-}"
OC4D_DATABASE_URL="${OC4D_DATABASE_URL:-}"
OC4D_DATABASE_URL_FILE="${OC4D_DATABASE_URL_FILE:-$PROJECT_ROOT/config/oc4d/database.url}"
OC4D_DB_DOCKER_CONTAINER="${OC4D_DB_DOCKER_CONTAINER:-oc4d_db}"
OC4D_ASSESSMENT_SOURCE="${OC4D_ASSESSMENT_SOURCE:-}"
...
OC4D_STAGING_KEEP="${OC4D_STAGING_KEEP:-2}"
OC4D_API_MAX_RESULTS="${OC4D_API_MAX_RESULTS:-100000}"
...
process_oc4d_assessments() {
  ...
  OC4D_API_TOKEN="$OC4D_API_TOKEN" \
  OC4D_API_IDENTIFIER="$OC4D_API_IDENTIFIER" \
  OC4D_API_PASSWORD="$OC4D_API_PASSWORD" \
  OC4D_API_CREDENTIALS_FILE="$OC4D_API_CREDENTIALS_FILE" \
  OC4D_DATABASE_URL="$OC4D_DATABASE_URL" \
  OC4D_DATABASE_URL_FILE="$OC4D_DATABASE_URL_FILE" \
  OC4D_DB_DOCKER_CONTAINER="$OC4D_DB_DOCKER_CONTAINER" \
  OC4D_ASSESSMENT_SOURCE="$OC4D_ASSESSMENT_SOURCE" \
  ...
  OC4D_CLOUD_STUDENTS_API_BASE_URL="$OC4D_CLOUD_STUDENTS_API_BASE_URL" \
  OC4D_CLOUD_API_TOKEN="$OC4D_CLOUD_API_TOKEN" \
  OC4D_STAGING_KEEP="$OC4D_STAGING_KEEP" \
  OC4D_API_MAX_RESULTS="$OC4D_API_MAX_RESULTS" \
