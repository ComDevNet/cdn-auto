...
- [automation.conf](./automation.conf) - generated by the automation configure script. Controls server version, device location label, S3 bucket/prefix, schedule, interval, ModuleGaze collection, and OC4D assessment pull settings.
