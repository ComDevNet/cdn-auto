...
- [oc4d/student-map.csv](./oc4d/student-map.csv) - optional overrides from local student email/username/name/UUID to cloud `studentId`; new students can resolve from cloud roster sources or existing S3 student prefixes
